...
#define MIN(A,B) ((A)<(B) ? (A) : (B))
  ...
  static inline void partial_qsort(double *a, int *ind, int firsti, int lasti, int s1)
  {
  ...
  /* Initializes assignment and basis with shortlist
   ...
   CG:initAssignment... */
  static inline void init_assignment(State *state)
  {
    int i, j, k;
  ...
  aleft = (int *)calloc((long) m, sizeof(int));
  bleft = (int *)calloc((long) n, sizeof(int));
  adone = (int *)calloc((long) m, sizeof(int));
  bdone = (int *)calloc((long) n, sizeof(int));
  ...
  static inline void find_first_unconnected(State *state, int *firsti, int *firstj)
  {
    int i,j;
    for (i = 0; i < state->m; i++) {
      for (j = 0; j < state->n; j++) {
    ...
    Rcpp::stop("no unconnected basis entry found in 'find_first_unconnected'");
  }
  ...
  static inline void label_connected(State *state, int firsti, int firstj)
  {
    int i,j,i0,j0;
  ...
  static inline void init_basis(State *state)
  {
    int i, j;
  ...
  if (ncurr > ntarget) {
    Rcpp::stop("the computed initial 'basis' has too many entries");
  }
  ...
  static inline void shl_init_helpers(State *state)
  {
    int i, j;
  ...
  static inline int shl_new_basic_variable_rowmostneg(State *state)
  {
    int i,j,newind;
    int count;
    double bestred;
  ...
  static inline int new_basic_variable_shortlist(State *state)
  {
    int i,j,k,newind;
  ...
  static inline void shl_find_circle(State *state)
  {
    int i, j; //int i, j, k;
    int lasti, lastj;
    int candi, candj;
  ...
  static inline void shl_move_mass(State *state)
  {
    int k;
  ...
  static inline void shl_add_to_basis(State *state)
  {
    int indi, indj;
  ...
  static inline void shl_remove_from_basis(State *state)
  {
    int i,j;
    int indi, indj;
  ...
  static inline void shl_printit(State *state)
  {
    int i,j;
    int m,n;
  ...
  static inline void shl_printfvec(int n, double *a)
  {
    int i;
  ...
  static inline void shl_printvec(int n, int *a)
  {
    int i;
  ...
  static inline void shl_printmat(int m, int n, int *a)
  {
    int i,j;
  ...
  static inline int shl_update_transport_rowmostneg(State *state)
  {
    int found;
    ...
    /* shl_printit(state); */
    /*  Rcpp::stop("test interrupt");  */
    
    return(0);  
  }
  
  
  static inline int update_transport_shortlist(State *state)
  {
    int found;
  ...
  static inline void init_shortlist(State *state)
  {
    int i, j, m, n;
  ...
  costfromrow = (double*)calloc((long) n, sizeof(double));
  indfromrow = (int *)calloc((long) n, sizeof(int));
  ...
  //' Runs the shortlist algorithm of Schuhmacher et al
   ...
   //' @return void
   //' @keywords internal
   static inline void shortsimplex(int *ss, int *kk, double *pp, 
